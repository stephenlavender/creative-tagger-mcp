...
assert "unreleased 47-tool, 10-prompt candidate" in readme
assert "Do not rebuild or republish it as `0.2.4`" in readme
...
assert "customer_url_fetch_disabled" in readme
assert "Everwell Labs (Demo)" in readme
