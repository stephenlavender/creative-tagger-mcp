...
class ToolSurfaceTest(unittest.TestCase):
    ...
    def test_readme_matches_published_surface_and_current_models(self) -> None:
        ...
        self.assertIn("metadata version `0.2.4`", readme)
        self.assertIn("immutable `v0.2.4` tag", readme)
        ...
        self.assertIn("Always use MCP discovery", readme)
    ...
    def test_release_smoke_checks_server_version_and_packaged_readme(self) -> None:
        ...
        self.assertIn("call list_workspaces first", source)
        self.assertIn('"metadata version `0.2.4`"', source)
        self.assertIn('"immutable `v0.2.4` tag"', source)
        self.assertIn('"Always use MCP discovery"', source)
