...
class ToolSurfaceTest(unittest.TestCase):
    ...
    def test_readme_matches_published_surface_and_current_models(self) -> None:
        ...
        self.assertIn("unpublished `0.2.5` candidate", readme)
        self.assertIn("pip install creative-tagger-mcp==0.2.4", readme)
        self.assertIn("PyPI still serves the immutable\n`creative-tagger-mcp==0.2.4`", readme)
        self.assertIn("47 public tools and 10 prompts", readme)
        self.assertIn("has no `v0.2.5` tag or\nPyPI release yet", readme)
        ...
        self.assertIn("companion API must be deployed", readme.replace("\n", " "))
    ...
    def test_tool_copy_uses_current_taxonomy_dimension_count(self) -> None:
        ...
        self.assertIn("packaged metadata are the\nunpublished `0.2.5` candidate", readme)
    ...
    def test_release_smoke_checks_server_version_and_packaged_readme(self) -> None:
        ...
        self.assertIn("call list_workspaces first", source)
        self.assertIn('"unpublished `0.2.5` candidate"', source)
